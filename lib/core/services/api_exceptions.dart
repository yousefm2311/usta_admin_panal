...
ApiException mapDioException(DioException e) {
  ...
  if (e.error is SocketException ||
    ...
    return NetworkException(
      t('No internet connection', 'لا يوجد اتصال بالإنترنت'),
    );
  }
  ...
  if (status != null) {
    switch (status) {
      ...
      case 404:
        return ApiException(
          t('Resource not found', 'المورد غير موجود'),
          statusCode: status,
        );
      case 409:
        return ApiException(
          t('Conflict, please try again', 'تعارض في الطلب، حاول مرة أخرى'),
          statusCode: status,
        );
      case 422:
        return ApiException(
      ...
      case 429:
        return ApiException(
          t(
            ...
            'طلبات كثيرة، يرجى الانتظار قليلاً',
          ),
          statusCode: status,
        );
      default:
        if (status >= 500) {
          return ServerException(
            t('Server error, please try later', 'خطأ من الخادم، حاول لاحقاً'),
            statusCode: status,
          );
        }
    }
