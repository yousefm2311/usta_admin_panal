...
class ArtisansService {
  ...
  Future<Response> fetchVerification(String id) =>
      _client.safe(() => _dio.get('/api/admin/verifications/$id'));
  ...
  Future<Response> approveVerification(String id) =>
      _client.safe(() => _dio.post('/api/admin/verifications/$id/approve'));

  Future<Response> rejectVerification(
    String id, {
    ...
    String? rejectionReasonInternal,
      ...
      _client.safe(
        () => _dio.post(
          ...
          data: {
            if (rejectionCategory != null && rejectionCategory.isNotEmpty)
              'rejectionCategory': rejectionCategory,
            if (rejectionReasonUserSafe != null &&
                rejectionReasonUserSafe.isNotEmpty)
              'rejectionReasonUserSafe': rejectionReasonUserSafe,
            if (rejectionReasonInternal != null &&
                rejectionReasonInternal.isNotEmpty)
  ...
  String verificationImageUrl(String id, String type) =>
      '${AppConfig.baseUrl}/api/admin/verification/$id/image/$type';
}
